import{r as y,R as u}from"./index-CTjT7uj6.js";import{m as T}from"./makeStyles-DFHNDtjR.js";import{B as b}from"./Box-4hiNbBw1.js";import{T as w}from"./Tooltip-CVVhu75l.js";import{T as q}from"./Typography-DtBgvzFq.js";import{c as A,d as j}from"./ApiRef-BSBwTmJJ.js";import{g as d}from"./mapValues-r4uG88u0.js";import{s as v,D as g}from"./ref-8pKZtiZi.js";const E=A({id:"plugin.catalog.entity-presentation"});function x(e,n){const{kind:i,namespace:r,name:s,title:t,description:a,displayName:o,type:p}=L(e),c=v({kind:i||"unknown",namespace:r||g,name:s||"unknown"}),l=N({kind:i,namespace:r,name:s,context:n}),m=[o,t,l].find(f=>f&&typeof f=="string"),k=[m!==c?c:void 0,p,a].filter(f=>f&&typeof f=="string").join(" | ");return{entityRef:c,primaryTitle:m,secondaryTitle:k||void 0,Icon:void 0}}const h=e=>!!e&&typeof e=="string";function L(e){if(typeof e=="string"){let n=e.indexOf(":");const i=e.indexOf("/");i!==-1&&i<n&&(n=-1);const r=n===-1?void 0:e.slice(0,n),s=i===-1?void 0:e.slice(n+1,i),t=e.slice(Math.max(n+1,i+1));return{kind:r,namespace:s,name:t}}if(typeof e=="object"&&e!==null){const n=[d(e,"kind")].find(h),i=[d(e,"metadata.namespace"),d(e,"namespace")].find(h),r=[d(e,"metadata.name"),d(e,"name")].find(h),s=[d(e,"metadata.title")].find(h),t=[d(e,"metadata.description")].find(h),a=[d(e,"spec.profile.displayName")].find(h),o=[d(e,"spec.type")].find(h);return{kind:n,namespace:i,name:r,title:s,description:t,displayName:a,type:o}}return{}}function N(e){var o,p,c,l,m;const n=((o=e.kind)==null?void 0:o.toLocaleLowerCase("en-US"))||"unknown",i=e.namespace||g,r=e.name||"unknown",s=(c=(p=e.context)==null?void 0:p.defaultKind)==null?void 0:c.toLocaleLowerCase("en-US"),t=(m=(l=e.context)==null?void 0:l.defaultNamespace)==null?void 0:m.toLocaleLowerCase("en-US");let a=r;return(t&&i.toLocaleLowerCase("en-US")!==t||i!==g)&&(a=`${i}/${a}`),s&&n.toLocaleLowerCase("en-US")!==s&&(a=`${n}:${a}`),a}function I(e,n,i){const[r,s]=y.useState(e);return y.useEffect(()=>{s(e);const t=n==null?void 0:n.subscribe({next:a=>{s(a)},complete:()=>{t==null||t.unsubscribe()}});return()=>{t==null||t.unsubscribe()}},i),r}function J(e,n){const r=j().get(E),s=[r,JSON.stringify(e),JSON.stringify(n||null)],t=y.useMemo(()=>{if(!r){const a=x(e,n);return{snapshot:a,promise:Promise.resolve(a)}}return r.forEntity(typeof e=="string"||"metadata"in e?e:v(e),n)},s);return I(t.snapshot,t.update$,[t])}const S=T(e=>({root:{display:"inline-flex",alignItems:"center",maxWidth:"100%"},icon:{marginRight:e.spacing(.5),color:e.palette.text.secondary,"& svg":{verticalAlign:"middle"}}}),{name:"CatalogReactEntityDisplayName"}),D=e=>{const{entityRef:n,hideIcon:i,disableTooltip:r,defaultKind:s,defaultNamespace:t}=e,a=S(),{primaryTitle:o,secondaryTitle:p,Icon:c}=J(n,{defaultKind:s,defaultNamespace:t});let l=u.createElement(w,{title:o,placement:"top",arrow:!0,"aria-label":o},u.createElement(q,{noWrap:!0,title:o,"aria-describedby":"tooltip-description"},o));return l=u.createElement(b,{component:"span",className:a.root},c&&!i?u.createElement(b,{component:"span",className:a.icon},u.createElement(c,{fontSize:"inherit"})):null,l),p&&!r&&(l=u.createElement(w,{enterDelay:1500,title:p},l)),l};D.__docgenInfo={description:`Shows a nice representation of a reference to an entity.
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  namespace: string;
  name: string;
}`,signature:{properties:[{key:"kind",value:{name:"string",required:!0}},{key:"namespace",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},{name:"string"}]},description:""},hideIcon:{required:!1,tsType:{name:"boolean"},description:""},disableTooltip:{required:!1,tsType:{name:"boolean"},description:""},defaultKind:{required:!1,tsType:{name:"string"},description:""},defaultNamespace:{required:!1,tsType:{name:"string"},description:""}}};export{D as E};
